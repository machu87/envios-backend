...
var order_controller_1 = require("./orders/order.controller");
...
var AppModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            providers: [auth_service_1.AuthService, order_service_1.OrderService, prisma_service_1.PrismaService, jwt_strategy_1.JwtStrategy],
        })];
